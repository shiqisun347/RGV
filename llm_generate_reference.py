...
if __name__ == "__main__":
    ...
    process_data = readfiles("data/webq_test_step2_12061815.jsonl")

    outfile = open("data/webq_test_step3_12061815.jsonl", 'a', encoding='utf8')
    ...
    while index < len(process_data):
        ...
        for _ in range(20):
            ...
            input_with_prompt = "Please respond to the current question from different dimensions (angle, granularity), and the answers should include specific entities rather than vague or non-specific statements.\nQuestion:{}? \n Answer is?".format(
                process_data[index]["unmasked_question"])
